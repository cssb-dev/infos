...
> 🚀 Vous venez de prendre la responsabilité d'un poste administratif à la CSSB,
...
> 📜 Ces postes sont mis au masculin, car à l'origine majoritairement occupées par des hommes. 
> Mais plusieurs femmes (souvent mamans de compagnons) se sont engagées sur certains postes 
> (parfois durant plusieurs années), et leur implication dans de plus en plus importante ces dernières années 
> est tout autant appréciée que nécessaire.
...
> 📜 L'ensemble des postes étant occupés par des bénévoles, il est recommandé au sein de la CSSB de transmettre régulièrement 
> les postes à d'autres personnes volontaires afin de ne pas se reposer trop longtemps sur les mêmes. 
> Idéalement, une **transmission** peut se faire **tous les un à deux ans**.
...
> 📜 Lors de la récupération d'un poste originalement vacant, ces informations vous sont transmise par d'autre membres des bureaux administratifs et de soutient concernés. 